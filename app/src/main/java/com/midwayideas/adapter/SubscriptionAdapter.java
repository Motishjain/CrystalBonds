package com.midwayideas.adapter;
...
import com.midwayideas.crystalbonds.R;
import com.midwayideas.database.DBHelper;
import com.midwayideas.database.Outlet;
...
public class SubscriptionAdapter extends RecyclerView.Adapter<SubscriptionAdapter.SubscriptionViewHolder> {
    ...
    public SubscriptionAdapter(Context context, int layoutResourceId, List<SubscriptionInfo> subscriptionInfoList, SubscriptionSelectionListener subscriptionSelectionListener) {
